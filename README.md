...
Search command exists to search for users with set roles. By default CI Bot will bolden users with "Corp Leadershi[" role and give them the (CAP/SCAP) tag based on if they have hte CAPITAL or SUPERCAPITAL groups.
